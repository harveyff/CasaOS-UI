 ...
 * @LastEditTime: 2022-07-04 19:33:14
    ...
    <section class="modal-card-body">
      ...
      <section v-if="currentSlide == 0">
        <template v-if="recommendList.length > 0">
          ...
          <div class="is-relative featured-app b-line pb-4">
            <swiper class="swiper " ref="featureSwiper" :options="featureSwiperOptions">
              <swiper-slide v-for="(item,index) in recommendList " :key="index+item.title+item.id" class="pb-3">
                ...
                <div class="is-flex pt-5 is-align-items-center">
                  <div class=" mr-3" @click="showAppDetial(item.id)">
                    <b-image :src="item.icon" :src-fallback="require('@/assets/img/app/default.png')" :placeholder="require('@/assets/img/app/default.png')" class="is-64x64 icon-shadow is-clickable"></b-image>
                  </div>
